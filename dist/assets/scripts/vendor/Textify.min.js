      ...
      490: function (e) {
        ...
        function o(e) {
          if (
            ...
            for (
              var t = e.charAt(0).toUpperCase() + e.slice(1), n = r.length;
              n--;
        ...
        (e.exports = function (e) {
          ...
          (e.exports.dash = function (e) {
            return (
              (e = o(e)),
              t.test(e) && ((e = "-" + e.replace(t, "-$1")), (t.lastIndex = 0)),
              e.toLowerCase()
            );
          });
      },
    ...
    (function () {
        ...
        return (f =
          "undefined" != typeof Reflect && Reflect.get
            ...
            : function (e, t, n) {
                ...
                if (o)
                  return (
                    (o = Object.getOwnPropertyDescriptor(o, t)),
                    o.get ? o.get.call(arguments.length < 3 ? e : n) : o.value
                  );
        ...
        h = (function () {
          function i(e) {
            ...
            (this.delay = o),
              ...
              (this.elements = e),
              (this.repeat = !1),
              (this.target = n ? t.closest(n) : t),
              (this.transformPrefix = p()("transform")),
              (this.isVisible = !1),
              "IntersectionObserver" in window
                ? (this.createObserver(), this.animateOut())
                : this.animateIn();
          }
          return (
            n(i, [
                  ...
                  this.observer = new window.IntersectionObserver(
                    function (e, t) {
                      e.forEach(function (e) {
                        !n.isVisible && e.isIntersecting
                          ? (n.animateIn(), n.repeat && t.unobserve(e.target))
                          : n.animateOut();
                      });
                    },
        ...
        (o = t.innerHTML.toString().trim()),
          ...
          o.forEach(function (e, t) {
            var n = !1,
              ...
              i = [];
            0 < t && c.push("<br>"),
              (c = c.concat(e.split(r))).forEach(function (e) {
                (n =
                  n || (!e.includes("<a") && !e.includes("<strong"))
                    ? n
                    : !(o = "")) && (o += " ".concat(e)),
                  n &&
                    (e.includes("/a>") || e.includes("/strong>")) &&
                    (i.push(o), (o = "")),
                  n || "" !== o || i.push(e),
                  n &&
                    (e.includes("/a>") || e.includes("/strong>")) &&
        ...
        var o,
          ...
          n =
            (c.forEach(function (e) {
              -1 < e.indexOf("<br>")
                ? e.split("<br>").forEach(function (e, t) {
                    i += 0 < t ? "<br>" + y(e) : y(e);
                  })
                : (i += y(e));
            }),
            (t.innerHTML = i),
            t.querySelectorAll("span"));
        e &&
      ...
      function y(e) {
        return "" === e
          ...
          : "<br>" === (e = e.trim())
          ? "<br>"
          : "<span>".concat(e, "</span>") + (1 < e.length ? " " : "");
      }
      function d(e) {
        if ("undefined" === e) return t.default;
        if (e && !t[e])
          throw new Error("Invalid Easing ".concat(e, " option."));
        return t[e];
      }
      var t = {
        ...
        function r(e) {
          ...
          return (
            0 === o.length &&
              (b({ element: t }),
              b({ element: t }),
              n.push.apply(n, s(t.querySelectorAll("span span")))),
            0 !== o.length &&
            ...
            (o.repeat = o.options.once),
            o.onResize(),
            "IntersectionObserver" in window && o.animateOut(),
            o
          );
        }
        return (
          n(r, [
            {
              ...
              value: function (e, t) {
                (e.style.transition = "transform "
                  .concat(this.options.duration, "ms ")
                  .concat(t * this.options.delay, "ms ")
                  .concat(this.options.easing, ", opacity ")
                  .concat(this.options.duration - 200, "ms ")
                  .concat(t * this.options.delay, "ms ")
                  .concat(this.options.fadeEasing)),
                  console.log(this.transformPrefix),
                  (e.style[this.transformPrefix] =
                    "translateY(0) scale(1) rotate(0)"),
                  this.options.fade && (e.style.opacity = "1");
              },
            },
            {
              key: "animateIn",
              value: function () {
                var n = this;
                f(u(r.prototype), "animateIn", this).call(this),
                  void 0 !== this.lines &&
                    ("object" === a(this.lines)
                      ? Object.keys(this.lines).forEach(function (e, t) {
            ...
            },
            {
              ...
              value: function () {
                var t = this;
                f(u(r.prototype), "animateOut", this).call(this),
                  void 0 !== this.lines &&
                    ("object" === a(this.lines)
                      ? Object.keys(this.lines).forEach(function (e) {
                          t.lines[e].forEach(function (e) {
                            (e.style[t.transformPrefix] = "translateY("
                              .concat(t.options.top ? "-" : "", "150%)  scale(")
                              .concat(t.options.scale, ") rotate(")
                              .concat(t.options.rotation, "deg)")),
                              t.options.fade && (e.style.opacity = "0");
                          });
                        })
            ...
            },
            {
              ...
              value: function () {
                var n, o, i, r;
                this.lines =
                  ((n = this.elements.lines),
                  (o = []),
                  (i = []),
                  (r = n[0].offsetTop),
                  n.forEach(function (e, t) {
                    e.offsetTop === r && i.push(e),
                      e.offsetTop !== r &&
                        (o.push(i), (i = []).push(e), (r = e.offsetTop)),
                      t + 1 === n.length && o.push(i);
                  }),
                  o);
              },
            },
        ...
        function i() {
          ...
          (this.elements = document.querySelectorAll(e)),
            (this.animations =
              ((t = this.elements),
              (n = function (e) {
                return new g({ element: e, options: o });
              }),
