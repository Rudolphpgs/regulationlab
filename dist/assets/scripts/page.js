!function($) {
    ...
    $(window).scroll(function(e) {
        ...
        10 < scrollY && $(".tooltipstered[data-tooltip-menu]").tooltipster("hide"), lastScrollTop < scrollY ? $("body").removeClass("scrolling_top") : $("body").addClass("scrolling_top"), 
        lastScrollTop = scrollY;
    }), $(document).ready(function() {
        pgs_.hash_scroll(), pgs_.menuscrollToDiv(), pgs_.scroll_menu_active(), pgs_.burgger_menu(), 
        pgs_.scroll_progress(), pgs_.window_hash_smooth_scroll(), $("[data-fancybox-modal]").fancybox({
            modal: !0
        }), $("[data-text-sp]").each(function() {
            $(this).splitLines({
                tag: "<span><i>"
            });
    ...
    $(function() {
        ...
        $(".pageSection ").viewportChecker({
            ...
            callbackFunction: function(elem, action) {
                $(elem).hasClass("aboutSection") && $("[data-count]").each(function() {
                    var count_ = $(this).data("count"), target_ = $(this).find(">span");
